...
<section id="pav-mass-bottom">
    <div class="container">
        ...
        <?php if( $i++%$cols == 0 || count($modules)==1 ){  $j=1;?><div class="row"><?php } ?>
            <div class="col-lg-<?php echo floor(12/$cols);?> col-md-<?php echo floor(12/$cols);?>"><?php echo $module; ?></div>
        ...
        <div class="container">
            <div class="wrap-powered">
                <div class="copyright pull-left">
                    ...
                    <?php } else { ?>
                    <?php } ?>
			Roza - Responsive & <a href="http://www.fastcomet.com/free-opencart-themes" title="Free OpenCart Themes">Free OpenCart Themes</a>. Designed by <a href="http://www.fastcomet.com/">FastComet</a>
                </div>
