<div class="box">
	...
	<div class="box-content" >
		...
		<div class="pavblog-latest row">
			...
			<div class="col-lg-<?php echo floor(12/$cols);?> col-md-<?php echo floor(12/$cols);?> col-sm-6 col-xs-12 pav-blog-list">
				<div class="blog-item">					
					<div class="blog-body">
						<?php if( $blog['thumb']  )  { ?>
							<div class="image">
						...
						<div class="date">
							<span class="created">
								<span><i class="fa fa-clock-o"></i> <?php echo $blog['created'];?></span>
							</span>
						</div>
