<article class="blog-item row">	
	...
	<div class="col-md-4 col-sm-5 col-xs-6">
		<figure class="blog-body image">						
			<img src="<?php echo $blog['thumb_small'];?>" title="<?php echo $blog['title'];?>" class="img-responsive" />
		</figure>		
	</div>	
	<?php } ?>	
	...
	<div class="col-md-8 col-sm-7 col-xs-6">
		...
		<footer>	
			<section class="blog-meta">
				...
				<span class="author"><span><i class="icon-pencil"></i><?php echo $this->language->get("text_write_by");?></span> <?php echo $blog['author'];?></span>
				<?php } ?>
				
				<?php if( $config->get('cat_show_category') ) { ?>
				<span class="publishin">
					<span><i class="icon-blog"></i><?php echo $this->language->get("text_published_in");?></span>
				...
				<span class="hits"><span><i class="icon-insert-template"></i><?php echo $this->language->get("text_hits");?></span> <?php echo $blog['hits'];?></span>
				<?php } ?>
				
				<?php if( $config->get('cat_show_comment_counter') ) { ?>
				<span class="comment_count"><span><i class="icon-comment"></i><?php echo $this->language->get("text_comment_count");?></span> <?php echo $blog['comment_count'];?></span>
				<?php } ?>
			</section>
