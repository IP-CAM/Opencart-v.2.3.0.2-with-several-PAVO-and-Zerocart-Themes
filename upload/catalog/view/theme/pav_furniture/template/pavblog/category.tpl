...
<div class="row">
	...
	<?php endif; ?> 
	<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-<?php echo $SPAN[1];?> col-xs-12">
		<div id="content">
				...
				<div class="pav-children no-margin">
					...
					<div class="children-wrap row">				
						...
						foreach( $children as $key => $sub )  { $key = $key + 1;?>
							<div class="col-lg-<?php echo floor(12/$cols);?> col-md-<?php echo floor(12/$cols);?> col-sm-<?php echo floor(12/$cols);?> col-xs-6">
								<div class="children-inner">
									<h4><a href="<?php echo $sub['link']; ?>" title="<?php echo $sub['title']; ?>"><?php echo $sub['title']; ?> (<?php echo $sub['count_blogs']; ?>)</a></h4>
									<?php if( $sub['thumb'] ) { ?>
										<div class="image">
											<img src="<?php echo $sub['thumb'];?>" class="img-responsive" />
										</div>
									<?php } ?>
	...
	<?php if( $SPAN[2] ): ?>
		<aside class="col-lg-<?php echo $SPAN[2];?> col-md-<?php echo $SPAN[2];?> col-sm-<?php echo $SPAN[2];?> col-xs-12">	
